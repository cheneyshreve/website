...
class Gender extends Component {
  ...
  <div>
    ...
    <Jumbotron title="Disaggregated Data" subtitle="Why it matters for disasters." />
     ...
     <br />
     <p>Many of us are inclined to speak about disasters as natural events we’re a captive of, something beyond our control; in part, this is true. Scientific consensus is pretty resounding that are influencing the climate and we are experiencing more severe, and more frequent, extreme weather events. These events tend to precipitate disasters however, they are not the root cause. A closer examination shows us that the causes of disasters are not natural hazard events, such as earthquakes, landslides, fires, or floods, but how we as a society, plan for (or don’t) these events. For example, are we building in floodplains, if so, are we taking adequate mitigation steps?  Are we building in soft sediments along active fault zones, if so, are the buildings able to withstand an earthquake, and how severe of an earthquake? Do we have a tsunami warning in place, and shelters?</p>
    <br />
